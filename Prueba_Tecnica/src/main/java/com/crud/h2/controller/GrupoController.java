...
public class GrupoController {
	...
	@GetMapping("/grupo-by-juego")
	public List<Grupo> grupoXJuego(@RequestParam int id) {
		return grupoServiceImp.buscarXJuego(id);
	}
	
	@GetMapping("/grupo-by-nombre")
	public List<Grupo> buscarXNombre(@RequestParam String nombre) {
		return grupoServiceImp.buscarXNombre(nombre);
	}
}
